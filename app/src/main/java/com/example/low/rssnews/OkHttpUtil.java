...
public class OkHttpUtil {
    ...
    /*public static DetailEntity getDetailByJSON(String json){
        return new Gson().fromJson(json, DetailEntity.class);
    }

    public static DetailVoteEntity getDetailVoteByJSON(String json){
        return new Gson().fromJson(json, DetailVoteEntity.class);
    }*/
}
